...
class webphoto_edit_import extends webphoto_edit_base
{
    ...
    public function init_myalbum($dirname)
    {
        ...
        list($this->_myalbum_photos_dir, $this->_myalbum_thumbs_dir) = $this->_myalbum_handler->get_photos_thumbs_dir();
    ...
    public function insert_comments_from_src($itemid, $src_rows)
    {
        ...
        foreach ($src_rows as $src_row) {
            ...
            $this->_xoops_comments_handler->update_rootid_pid($com_id_new, $com_rootid_new, $com_pid_new);
