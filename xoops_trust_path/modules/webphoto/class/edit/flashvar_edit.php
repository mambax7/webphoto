...
class webphoto_edit_flashvar_edit extends webphoto_edit_base
{
    ...
    /**
     * webphoto_edit_flashvar_edit constructor.
     * @param $dirname
     * @param $trust_dirname
     */
     ...
     * @return \webphoto_edit_flashvar_edit|\webphoto_lib_error
     */
    ...
    public function fetch_logo()
    {
        ...
        if ($tmp_name && $media_name) {
            ...
            $this->_image_cmd_class->resize_rotate($tmp_file, $logo_file, $this->_cfg_logo_width, $this->_cfg_logo_width);
