...
class webphoto_xoops_base
{
    ...
    public $_SYSTEM_GROUPS = array(XOOPS_GROUP_ADMIN, XOOPS_GROUP_USERS, XOOPS_GROUP_ANONYMOUS);
    ...
    public function has_my_module_config()
    {
        ...
        return count($config_handler->getConfigs(new Criteria('conf_modid', $this->_MY_MODULE_ID)));
    }
