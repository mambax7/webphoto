...
class webphoto_admin_item_manager extends webphoto_edit_action
{
    ...
    public function _video()
    {
        ...
        list($url, $time, $msg) = $this->build_redirect($this->_build_redirect_param($mode, $item_id, !$ret));
    ...
    // flashvar submit
    //---------------------------------------------------------
    public function _flashvar_submit()
    {
        // Fatal error: Class 'webphoto_flashvar_edit'
        $edit_class = webphoto_edit_flashvar_edit::getInstance($this->_DIRNAME, $this->_TRUST_DIRNAME);
        ...
        list($url, $time, $msg) = $this->_build_flashvar_redirect($ret, $edit_class->get_format_error(), $edit_class->get_error_upload());
    ...
    // flashvar modify
    //---------------------------------------------------------
    public function _flashvar_modify()
    {
    ...
    // flashvar restore
    //---------------------------------------------------------
    public function _flashvar_restore()
    {
        $edit_class = webphoto_flashvar_edit::getInstance($this->_DIRNAME, $this->_TRUST_DIRNAME);
    ...
    public function _vote_print_user_table($item_id, $user_rows)
    {
        ...
        foreach ($user_rows as $row) {
            ...
            echo '<tr>';
            echo $this->_vote_build_line($this->_xoops_class->get_user_uname_from_id($uid));
            ...
            echo $this->_vote_build_line(formatTimestamp($row['vote_time_update']));
            echo $this->_vote_build_line($this->_vote_text_form($item_id, $row['vote_id']), 'center');
            echo "</tr>\n";
        }
    ...
    public function init_admin_item_form()
    {
