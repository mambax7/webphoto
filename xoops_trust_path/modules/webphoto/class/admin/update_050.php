...
class webphoto_admin_update_050 extends webphoto_base_this
{
    ...
    /**
     * webphoto_admin_update_050 constructor.
     * @param $dirname
     * @param $trust_dirname
     */
     ...
     * @return \webphoto_admin_update_050|\webphoto_lib_error
     */
     ...
     * @return int|mixed
     */
    public function get_kind($item_row)
    {
     ...
     * @return string
     */
    public function get_displaytype($item_row)
    {
        $ext = $item_row['item_ext'];
     ...
     * @return string
     */
    public function get_onclick($item_row)
    {
        $ext = $item_row['item_ext'];
     ...
     * @return int
     */
    public function get_duration($item_row)
    {
        $duration = 0;
        ...
        $cont_row = $this->_fileHandler->get_row_by_id($cont_id);
    ...
    // update_player
    //---------------------------------------------------------
    public function _update_player()
    {
