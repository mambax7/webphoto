...
class webphoto_admin_mime_form extends webphoto_edit_form
{
    ...
    // print form
    //---------------------------------------------------------
    public function print_form_mimefind()
    {
        ...
        echo $this->build_line_ele(_AM_WEBPHOTO_MIME_EXTFIND, $this->build_input_text('fileext', ''));

        echo $this->build_line_ele('', $this->build_input_submit('submit', _AM_WEBPHOTO_MIME_FINDIT, $extra));
