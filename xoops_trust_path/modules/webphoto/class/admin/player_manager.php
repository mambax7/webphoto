...
class webphoto_admin_player_manager extends webphoto_base_this
{
    ...
    public function _delete_comfirm()
    {
        ...
        echo $form_class->build_form_confirm($hiddens, $url, _AM_WEBPHOTO_PLAYER_WARNING, _YES, _NO);

        xoops_cp_footer();
        exit();
    }

    public function _delete_excute()
    {
        if (!$this->check_token()) {
            redirect_header($this->_THIS_URL, $this->_TIME_FAIL, $this->get_token_errors());
        }
