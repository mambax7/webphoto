...
class webphoto_admin_checkconfigs extends webphoto_base_this
{
    ...
    /**
     * webphoto_admin_checkconfigs constructor.
     * @param $dirname
     * @param $trust_dirname
     */
     ...
     * @return \webphoto_admin_checkconfigs|\webphoto_lib_error
     */
    ...
    public function _check_program()
    {
        ...
        $jodconverter_class = webphoto_jodconverter::getInstance($this->_DIRNAME, $this->_TRUST_DIRNAME);
        ...
        if ((_C_WEBPHOTO_PIPEID_IMAGICK == $cfg_imagingpipe)
            || $cfg_imagickpath) {
        ...
        if ((_C_WEBPHOTO_PIPEID_NETPBM == $cfg_imagingpipe)
            || $cfg_netpbmpath) {
            echo "<b>NetPBM</b><br>\n";
    ...
    public function _check_full_path($full_path, $flag_root_path = false)
    {
        ...
        if (mb_substr($full_path, -1) == $this->_CHAR_SLASH) {
            ...
            if (0 === mb_strpos($full_path, XOOPS_ROOT_PATH)) {
                echo "<br>\n";
