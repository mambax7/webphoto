...
class webphoto_admin_item_table_manage extends webphoto_lib_manage
{
    ...
    /**
     * webphoto_admin_item_table_manage constructor.
     * @param $dirname
     * @param $trust_dirname
     */
    public function __construct($dirname, $trust_dirname)
    {
        ...
        $this->set_manage_list_column_array(['item_title', 'item_uid']);
     ...
     * @return \webphoto_admin_item_table_manage|\webphoto_lib_element|\webphoto_lib_error|\webphoto_lib_form
     */
