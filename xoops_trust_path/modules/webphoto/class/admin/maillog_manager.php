...
class webphoto_admin_maillog_manager extends webphoto_lib_manage
{
    ...
    public function XXX_print_form($row)
    {
        ...
        echo $this->build_line_ele($this->get_constant('maillog_photo_ids'), $this->_build_ele_photo_ids());

        echo $this->build_line_ele($this->get_constant('maillog_status'), $this->_build_ele_status());

        echo $this->build_comp_label('maillog_from');
        echo $this->build_comp_label('maillog_subject');
        echo $this->build_comp_label('maillog_body');

        echo $this->build_line_ele($this->get_constant('maillog_file'), $this->_build_ele_file());

        echo $this->build_line_ele($this->get_constant('maillog_attach'), $this->_build_ele_attach($status));

        echo $this->build_line_ele($this->get_constant('maillog_comment'), $this->_build_ele_comment());
