...
class webphoto_admin_update_040 extends webphoto_base_this
{
    ...
    /**
     * webphoto_admin_update_040 constructor.
     * @param $dirname
     * @param $trust_dirname
     */
     ...
     * @return \webphoto_admin_update_040|\webphoto_lib_error
     */
    ...
    public function _update_photo()
    {
        ...
        foreach ($photo_rows as $photo_row) {
            ...
            // flash
            if ('flv' == $file_ext) {
                $file_id_flash = $this->_insert_file_file(_C_WEBPHOTO_FILE_KIND_VIDEO_FLASH, $photo_row);
            }
     ...
     */
    public function _insert_item($photo_row)
    {
     ...
     * @return bool|void
     */
    public function _insert_file_cont($photo_row)
    {
        ...
        return $this->_fileHandler->insert($row);
    }
     ...
     * @return bool|void
     */
    public function _insert_file_thumb($photo_row)
    {
        $row = $this->_fileHandler->create();
        $row['file_time_create'] = $photo_row['photo_time_create'];
        $row['file_time_update'] = $photo_row['photo_time_update'];
     ...
     * @return bool|void
     */
    public function _insert_file_file($kind, $photo_row)
    {
        $row = $this->_fileHandler->create();
        $row['file_time_create'] = $photo_row['photo_time_create'];
        $row['file_time_update'] = $photo_row['photo_time_update'];
        ...
        if (_C_WEBPHOTO_FILE_KIND_VIDEO_FLASH == $kind) {
            $row['file_width'] = $photo_row['photo_cont_width'];
            $row['file_height'] = $photo_row['photo_cont_height'];
            $row['file_duration'] = $photo_row['photo_cont_duration'];
        }
     ...
     * @return bool|void
     */
    public function _insert_file_docomo($photo_row)
    {
        $row = $this->_fileHandler->create();
        $row['file_time_create'] = $photo_row['photo_time_create'];
        $row['file_time_update'] = $photo_row['photo_time_update'];
     ...
     * @return bool|void
     */
    public function _insert_file_middle($photo_row, $param)
    {
        $row = $this->_fileHandler->create();
        $row['file_time_create'] = $photo_row['photo_time_create'];
        $row['file_time_update'] = $photo_row['photo_time_update'];
        ...
        return $this->_fileHandler->insert($update);
    }
     ...
     * @return int
     */
    public function _build_item_kind($photo_row)
    {
        $kind = 0;
        if ($this->is_normal_ext($photo_row['photo_cont_ext'])) {
            $kind = _C_WEBPHOTO_ITEM_KIND_IMAGE;
        } elseif ('video' == $photo_row['photo_cont_medium']) {
     ...
     * @return array|bool
     */
    public function _build_image_middle($photo_row)
    {
        $mime = '';
        $medium = '';
        $width = 0;
     ...
     * @return array|bool
     */
    public function _create_image_middle($photo_row)
    {
        $photo_id = $photo_row['photo_id'];
        ...
        $ret = $this->_image_cmd_class->resize_rotate($src_file, $dst_file, $this->_cfg_middle_width, $this->_cfg_middle_height);
