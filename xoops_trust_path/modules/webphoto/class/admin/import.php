...
class webphoto_admin_import extends webphoto_edit_import
{
    ...
    /**
     * webphoto_admin_import constructor.
     * @param $dirname
     * @param $trust_dirname
     */
     ...
     * @return \webphoto_admin_import|\webphoto_edit_import|\webphoto_lib_error
     */
    ...
    public function _import_image_cat($src_cid)
    {
        ...
        $image_row = $this->_imageHandler->get_category_row_by_id($src_cid);
    ...
    public function _import_image_photos($src_cid, $new_cid)
    {
        ...
        $image_rows = $this->_imageHandler->get_image_rows_by_catid($src_cid);
    ...
    public function _import_image_read_src($image_row, $tmp_file, $imgcat_storetype)
    {
        ...
        if ('db' == $imgcat_storetype) {
            $body_row = $this->_imageHandler->get_body_row_by_imageid($image_id);
    ...
    public function _import_myalbum_cat($src_cid)
    {
        ...
        $myalbum_row = $this->_myalbumHandler->get_cat_row_by_id($src_cid);
    ...
    public function _import_myalbum_photos($src_cid, $new_cid)
    {
        ...
        $myalbum_rows = $this->_myalbumHandler->get_photos_rows_by_cid($src_cid);
        $import_count = 0;
    ...
    {
        $myalbum_rows = $this->_myalbumHandler->get_votedata_row_by_lid($lid);
    ...
    public function _add_file_from_webphoto($item_id, $webphoto_file_id)
    {
        ...
        $newid = $this->_fileHandler->insert($file_row);
        if (!$newid) {
            echo ' db error ';
    ...
    {
        $this->_form_class = webphoto_admin_import_form::getInstance($this->_DIRNAME, $this->_TRUST_DIRNAME);
    ...
    public function _print_form_image()
    {
        ...
        $cat_rows = $this->_imageHandler->get_category_rows_with_image_count();
    ...
    public function _print_form_myalbums()
    {
        ...
        foreach ($module_array as $mod) {
            ...
            $selbox = $this->_myalbumHandler->build_cat_selbox($number);
