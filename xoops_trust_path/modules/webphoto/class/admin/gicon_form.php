...
class webphoto_admin_gicon_form extends webphoto_edit_form
{
    ...
    /**
     * webphoto_admin_gicon_form constructor.
     * @param $dirname
     * @param $trust_dirname
     */
     ...
     * @return \webphoto_admin_gicon_form|\webphoto_edit_form|\webphoto_lib_element|\webphoto_lib_error|\webphoto_lib_form
     */
    ...
    public function _build_line_image_file()
    {
        ...
        return $this->build_line_cap_ele(_AM_WEBPHOTO_GICON_IMAGE_SEL, $desc, $ele);
    }
    ...
    {
        return $this->build_line_ele(_AM_WEBPHOTO_GICON_SHADOW_SEL, $this->_build_ele_shadow_file());
    }
    ...
    public function _build_ele_shadow_file()
    {
        ...
        if ($path) {
            ...
            $del_opts = [_AM_WEBPHOTO_GICON_SHADOW_DEL => _C_WEBPHOTO_YES];
