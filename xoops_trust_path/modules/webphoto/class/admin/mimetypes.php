...
class webphoto_admin_mimetypes extends webphoto_base_this
{
    ...
    // delete cofirm
    //---------------------------------------------------------
    public function _delete_confirm()
    {
        $post_mime_id = $this->_post_class->get_post_int('mime_id');
    ...
    //---------------------------------------------------------
    public function _print_show_allowed_mime_all()
    {
        echo '<fieldset>';
        echo '<legend style="' . $this->_STYLE_LEGEND . '">';
        ...
        foreach ($this->_xoops_group_objs as $obj) {
            echo $this->_build_show_allowed_mime_single($obj->getVar('groupid'), $obj->getVar('name'));
        }
    ...
    {
        foreach ($this->_xoops_group_objs as $obj) {
            $this->_build_allowed_mime_array_single($obj->getVar('groupid'), $mime_ext, $perm_array);
        }
    }
    ...
    public function _print_mime_form_mimefind()
    {
        $mime_form = webphoto_admin_mime_form::getInstance($this->_DIRNAME, $this->_TRUST_DIRNAME);
