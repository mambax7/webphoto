...
class webphoto_show_image
{
    ...
    /**
     * webphoto_show_image constructor.
     * @param $dirname
     * @param $trust_dirname
     */
    public function __construct($dirname, $trust_dirname)
    {
        ...
        list($this->_max_large_width, $this->_max_large_height) = $this->_config_class->get_large_wh();

        list($this->_max_middle_width, $this->_max_middle_height) = $this->_config_class->get_middle_wh();

        list($this->_max_thumb_width, $this->_max_thumb_height) = $this->_config_class->get_thumb_wh();
    ...
    public function build_image_by_item_row($item_row, $default)
    {
        ...
        $cont_row = $this->get_cached_file_extend_row_by_name($item_row, _C_WEBPHOTO_ITEM_FILE_CONT);
        $thumb_row = $this->get_cached_file_extend_row_by_name($item_row, _C_WEBPHOTO_ITEM_FILE_THUMB);
        $large_row = $this->get_cached_file_extend_row_by_name($item_row, _C_WEBPHOTO_ITEM_FILE_LARGE);
        $middle_row = $this->get_cached_file_extend_row_by_name($item_row, _C_WEBPHOTO_ITEM_FILE_MIDDLE);
        $small_row = $this->get_cached_file_extend_row_by_name($item_row, _C_WEBPHOTO_ITEM_FILE_SMALL);
    ...
    public function build_image_by_param($param)
    {
        ...
        list($middle_url, $middle_width, $middle_height) = $this->build_show_file_image($middle_row);
        ...
        list($img_large_width, $img_large_height) = $this->adjust_middle_size($img_large_width, $img_large_height);

        list($img_middle_width, $img_middle_height) = $this->adjust_middle_size($img_middle_width, $img_middle_height);

        list($img_thumb_width, $img_thumb_height) = $this->adjust_thumb_size($img_thumb_width, $img_thumb_height);
    ...
    {
        return $this->_item_handler->build_show_icon_image($item_row, $this->_ROOT_EXTS_URL);
    }
