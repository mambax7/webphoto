...
class webphoto_date extends webphoto_base_this
{
     ...
     * @return \webphoto_date|\webphoto_lib_error
     */
    ...
    {
        $list_rows = $this->_item_handler->get_rows_by_groupby_orderby($this->_PHOTO_LIST_DATE_GROUP, $this->_PHOTO_LIST_DATE_ORDER);
        ...
        foreach ($list_rows as $row) {
            ...
            if (!isset($year_month_arr_1[$year_month])) {
                ...
                // get first row
                $photo_rows = $this->_public_class->get_rows_by_like_datetime_orderby($year_month, $this->_PHOTO_LIST_DATE_ORDER, 1);
        ...
        foreach ($year_month_arr_1 as $year_month => $arr) {
            ...
            // get all rows
            $photo_rows = $this->_public_class->get_rows_by_like_datetime_orderby($year_month, $this->_PHOTO_LIST_DATE_ORDER);
        ...
        foreach ($year_month_arr_2 as $year_month => $arr) {
            ...
            if (_C_WEBPHOTO_DATETIME_STR_NOT_SET == $year_month) {
     ...
     * @return array
     */
    public function build_total_for_detail($datetime_in)
    {
     ...
     * @return mixed|null
     */
    public function build_datetime_for_detail($datetime_in)
    {
     ...
     * @return array|bool
     */
    public function build_rows_for_detail($datetime, $orderby, $limit = 0, $start = 0)
    {
        return $this->_public_class->get_rows_by_like_datetime_orderby($datetime, $orderby, $limit, $start);
    }
     ...
     * @return string
     */
    public function build_title($datetime)
    {
        if (_C_WEBPHOTO_DATETIME_STR_NOT_SET == $datetime) {
     ...
     * @return array|bool
     */
    public function build_rows_for_rss($datetime_in, $orderby, $limit = 0, $start = 0)
    {
        $datetime = $this->build_datetime_for_detail($datetime_in);

        return $this->build_rows_for_detail($datetime, $orderby, $limit, $start);
    }
