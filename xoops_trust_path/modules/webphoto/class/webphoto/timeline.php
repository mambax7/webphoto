...
if (!class_exists('webphoto_timeline')) {
    ...
    class webphoto_timeline extends webphoto_base_this
    {
        ...
        public $_SHOW_FALSE = ['show_timeline' => false];
         ...
         * @return \webphoto_lib_error|\webphoto_timeline
         */
        ...
        public function build_for_detail($param, $flag_large)
        {
            ...
            $param = $this->build_timeline_from_photos($unit, $date, $photos, $flag_large);
        ...
        public function get_unit_default($param)
        {
            ...
            switch ($mode) {
                case 'category':
                    $scale = $this->_catHandler->get_cached_timeline_scale_by_id($cat_id);
        ...
        {
            $latest_rows = $this->get_rows_by_orderby($this->_ORDERBY_LATEST, $this->_cfg_timeline_latest);

            $random_rows = $this->get_rows_by_orderby($this->_ORDERBY_RANDOM, $this->_cfg_timeline_random);
        ...
        {
            $latest_rows = $this->get_rows_by_catid_orderby($cat_id, $this->_ORDERBY_LATEST, $this->_cfg_timeline_latest);

            $random_rows = $this->get_rows_by_catid_orderby($cat_id, $this->_ORDERBY_RANDOM, $this->_cfg_timeline_random);
        ...
        public function build_timeline_from_photos($unit, $date, $photos, $flag_large)
        {
            ...
            if ($this->_init_timeline) {
                $param = $this->_timeline_init_class->fetch_timeline('painter', $unit, $date, $photos);
         ...
         * @return array|bool
         */
        public function build_photo_single($row)
        {
            $item_id = $row['item_id'];
        ...
        public function get_rows_by_catid_orderby($cat_id, $orderby, $limit = 0, $offset = 0)
        {
            ...
            return $this->_public_class->get_rows_by_catid_array_orderby($catid_array, $orderby, $limit, $offset);
        }
