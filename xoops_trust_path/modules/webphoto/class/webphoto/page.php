...
class webphoto_page extends webphoto_base_this
{
    ...
    {
        $arr = array_merge($this->build_xoops_param(), $this->build_config_param(), $this->build_perm_param(), $this->build_show_param(), $this->build_menu_param(), $this->build_footer_param(),
                           $this->get_lang_array());
        return $arr;
    }
