...
class webphoto_main_edit extends webphoto_edit_action
{
    ...
    public function _modify()
    {
        ...
        list($url, $time, $msg) = $this->build_redirect($this->_build_redirect_param(false, $item_id));
    ...
    public function _redo()
    {
        ...
        list($url, $time, $msg) = $this->build_redirect($this->_build_redirect_param($is_failed, $item_id));
    ...
    public function _video()
    {
        ...
        list($url, $time, $msg) = $this->build_redirect($this->_build_redirect_param(!$ret, $item_id));
