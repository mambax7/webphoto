...
class webphoto_inc_xoops_version extends webphoto_inc_base_ini
{
    ...
    public static function getSingleton($dirname, $trust_dirname)
    {
        ...
        if (!isset($singletons[$dirname])) {
            $singletons[$dirname] = new webphoto_inc_xoops_version($dirname, $trust_dirname);
        }
    ...
    public function build_modversion()
    {
        ...
        if ($this->_is_module_admin && $xReferer && (strtolower($_SERVER['REQUEST_METHOD']) == 'post')) {
    ...
    public function _build_blocks()
    {
        ...
        if (!defined('XOOPS_CUBE_LEGACY') && substr(XOOPS_VERSION, 6, 3) < 2.1 && !empty($_POST['fct']) && !empty($_POST['op']) && $_POST['fct'] == 'modulesadmin' && $_POST['op'] == 'update_ok'
