...
<rss version="2.0"
    ...
    <{* $Id: main_rss.html,v 1.1.1.1 2008/06/21 12:22:18 ohwada Exp $ *}>
    <channel>
                    ...
                    <enclosure url="<{$item.enclosure_url}>" type="<{$item.enclosure_type}>" length="<{$item.enclosure_length}>">
                        ...
                        <enclosure url="<{$item.enclosure_url}>">
                            ...
                            <media:group>
                                ...
                                <media:content url="<{$item.media_content_url}>" fileSize="<{$item.media_content_filesize}>" width="<{$item.media_content_width}>" height="<{$item.media_content_height}>"
                                               type="<{$item.media_content_type}>" medium="image">
                                    ...
                                    <media:content url="<{$item.media_content_url}>" fileSize="<{$item.media_content_filesize}>" type="<{$item.media_content_type}>" medium="image">
                                        ...
                                        <media:content url="<{$item.media_content_url}>" medium="image">
                                            ...
                                            <media:content url="<{$item.media_content_url}>" fileSize="<{$item.media_content_filesize}>" duration="<{$item.media_content_duration}>" type="<{$item.media_content_type}>"
                                                           medium="video">
                                                <{elseif $item.media_content_filesize && $item.media_content_type }>
