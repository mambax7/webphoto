...
<head>
    <{* $Id: main_gmap_location.html,v 1.3 2008/12/18 13:23:16 ohwada Exp $ *}>
...
<{if $show_gmap }>
    ...
    <{* -- gmap loop -- *}>
    <{counter name="gmap_i" assign="gmap_i" start=0 print=false }>
    <br>
<{foreach item=gmap from=$gmap_list}>
    <script type="text/javascript">
        //<![CDATA[

        webphoto_gmap_info[ < {$gmap_i} >
        ]
        = new Array( < {
            $gmap.item_gmap_latitude
        } >,
        <
        {
            $gmap.item_gmap_longitude
        }
        >,
        0, '<{$gmap.info}>'
        )
