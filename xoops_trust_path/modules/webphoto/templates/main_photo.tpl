<{* $Id: main_photo.html,v 1.21 2010/11/04 02:24:16 ohwada Exp $ *}>
...
<{if $show_gmap }>
    ...
    <script type="text/javascript">
        ...
        webphoto_gmap_info[0] = new Array( < {
            $gmap_photo.gmap_latitude
        } >,
        <
        {
            $gmap_photo.gmap_longitude
        }
        >, <
        {
            $gmap_photo.gmap_icon_id
        }
        >,
        '<{$gmap_photo.gmap_info}>'
        )
        ;
...
<div align="center">
    <{include file="db:`$mydirname`_inc_photo_view.tpl"}>
</div><br>

<{if $photo.show_codebox }>
    <div align="center">
        <{include file="db:`$mydirname`_inc_photo_codebox.tpl"}>
    </div>
    <br>
<{/if}>
...
<div align="left">
    ...
    <{include file="db:`$mydirname`_inc_photo_desc.tpl"}>
</div>

<{* EDIT ICON *}>
<{if $photo.can_edit}>
    <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/index.php?fct=edit&amp;photo_id=<{$photo.photo_id}>">
        <img src="<{$xoops_url}>/modules/<{$xoops_dirname}>/images/icons/edit.png" border="0" alt="<{$lang_title_edit}>" title="<{$lang_title_edit}>"><{$lang_title_edit}></a>
    <br>
<{/if}>
