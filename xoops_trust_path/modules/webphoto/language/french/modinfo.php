...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined($constpref . 'LANG_LOADED')) {
    ...
    define($constpref . 'CFG_DESCFORCEGD2',
           "Cette option permet l'emploi de GD2 (conversion Truecolor).<br />Certaines configurations de PHP peuvent échouer dans le traitement des miniatures<br />Ce paramètre n'est actif que si vous avez sélectionné la librairie GD");
    define($constpref . 'CFG_IMAGICKPATH', "Chemin d'accès à ImageMagick");
    define($constpref . 'CFG_DESCIMAGICKPATH',
           "Bien que le chemin d'accès puisse être renseigné, laisser vide ce champ fonctionne avec la plupart des environnements.<br />Ce paramètre n'est actif que si vous avez sélectionné la librairie ImageMagick");
    define($constpref . 'CFG_NETPBMPATH', "Chemin d'accès à NetPBM");
    define($constpref . 'CFG_DESCNETPBMPATH',
           "Bien que le chemin d'accès puisse être renseigné, laisser vide ce champ fonctionne avec la plupart des environnements<br />Ce paramètre n'est actif que si vous avez sélectionné la librairie NetPBM");
    ...
    define($constpref . 'CFG_DESCWIDTH',
           "Si la largeur de la photo originale excède cette limite, elle sera redimensionnée.<br />Si vous utilisez la librairie GD sans forcer la conversion des miniatures (GD2) aucune redimension n'est opérée, l'image ne sera pas acceptée.");
    define($constpref . 'CFG_HEIGHT', 'Hauteur maximale de la photo');
    define($constpref . 'CFG_DESCHEIGHT',
           "Si la hauteur de la photo originale excède cette limite, elle sera redimensionnée.<br />Si vous utilisez la librairie GD sans forcer la conversion des miniatures (GD2) aucune redimension n'est opérée, l'image ne sera pas acceptée.");
    ...
    define($constpref . 'CFG_DESCUSESITEIMG',
           '[siteimg] remplacera [img] instead of [img].<br />Pour ce faire, vous devez modifier le fichier module.textsanitizer.php pour chacun des modules employant [siteimg]');
    ...
    define($constpref . 'CFG_APIKEY_DSC',
           'Pour obtenir votre clé Google :<br/><a href="http://www.google.com/apis/maps/signup.html" target="_blank">Google Maps API</a><br /><br />Les paramètres disponibles sont détaillés sur cette page :<br /><a href="http://www.google.com/apis/maps/documentation/reference.html" target="_blank">Google Maps API Reference</a>');
    ...
    define($constpref . 'CFG_FILE_DIR_DSC',
           "Saisir le chemin complet (le premier caractère doit être '/' et le dernier ne doit pas être '/'). Il est recommande de placer ce dossier hors accès web (zone sécurisée du serveur).");
...
Mot de passe: xxx<br />');
    ...
    define($constpref . 'CFG_UPLOADSPATH_DSC',
           "Chemin d'accès au répertoire depuis la racine du site<br />(le premier caractères doit être '/' et le dernier ne doit pas être '/'). Le répertoire doit être CHMODé en 777 ou 707.");
    define($constpref . 'CFG_MEDIASPATH', "Chemin d'accès aux médias");
    define($constpref . 'CFG_MEDIASPATH_DSC',
           "Le répertoire où sont placés les fichiers constituant les playlists.<br />Chemin d'accès au répertoire depuis la racine du site<br />(le premier caractères doit être '/' et le dernier ne doit pas être '/')");
    ...
    define($constpref . 'CFG_WORKDIR_DSC',
           "Saisir le chemin d'accès complet (le premier caractères doit être '/' et le dernier ne doit pas être '/'.)<br />Il est recommande de placer ce dossier hors accès web (zone sécurisée du serveur).");
    ...
    define($constpref . 'CFG_XPDFPATH_DSC',
           "Bien que le chemin d'accès puisse être renseigné, laisser vide ce champ fonctionne avec la plupart des environnements.<br />Ce paramètre n'est efficient qu'à la condition d'utiliser xpdf");
