...
if (!defined($constpref . 'LANG_LOADED')) {
    ...
    define($constpref . 'CFG_DESCPHOTOSPATH',
           "Percurso do diretório onde está instalado o XOOPS.<br />(O primeiro caracter deve ser '/'. O último caracter não deve ser '/'.)<br />As permissões deste diretório deve ser 777 ou 707 no unix.");
    ...
    define($constpref . 'CFG_DESCIMAGINGPIPE',
           'Quase todos os ambientes em PHP podem usar GD. Mas GD é funcionalmente inferior a dois outros pacotes.<br />É melhor usar ImageMagick ou NetPBM, se você puder.');
    define($constpref . 'CFG_FORCEGD2', 'Forçar conversão para GD2');
    define($constpref . 'CFG_DESCFORCEGD2',
           'Mesmo se o GD estiver disponível na versão do PHP, isso forçará a conversão para GD2(truecolor).<br />Algumas configurações do PHP falham na criação de miniaturas com GD2<br />Está configuração é relevante unicamente quando for usado GD');
    define($constpref . 'CFG_IMAGICKPATH', 'Percurso para o ImageMagick');
    define($constpref . 'CFG_DESCIMAGICKPATH',
           "Embora todo o percurso para 'convert' deva estar escrito, deixe isso em branco na maioria dos ambientes.<br />Está configuração é relevante unicamente quando for usado ImageMagick");
    define($constpref . 'CFG_NETPBMPATH', 'Percurso para o NetPBM');
    define($constpref . 'CFG_DESCNETPBMPATH',
           "Embora todo o percurso para 'pnmscale' deva estar escrito, deixe isso em branco na maioria dos ambientes.<br />Está configuração é relevante unicamente quando for usado NetPBM");
    ...
    define($constpref . 'CFG_DESCUSESITEIMG',
           'A integração da administração de imagens insere [siteimg] ao invés de [img].<br />Você tem de hackear o módulo.textsanitizer.php para cada módulopara habilitar a tag do [siteimg]');
    ...
    define($constpref . 'CFG_APIKEY_DSC',
           'Obtenha o código do API em <br/><a href="http://www.google.com/apis/maps/signup.html" target="_blank">Inscrever-se no Google Maps API</a><br /><br />Para detalhes do parâmetro, veja o que segue<br /><a href="http://www.google.com/apis/maps/documentation/reference.html" target="_blank">Referência Google Maps API</a>');
    ...
    define($constpref . 'CFG_DESCFFMPEGPATH',
           "Embora todo o percurso para o 'ffmpeg' deva ser escrito, deixe-o em branco na maioria dos ambientes.<br />Esta configuração é relevante apenas quando 'Usar ffmpeg' é sim");
    ...
    define($constpref . 'CFG_TMPDIR_DSC',
           "Preencha todo o percurso (O primeiro caracter deve ser '/'. O último caracter não deve ser '/'.)<br />É recomendado configurar isso fora do diretório raiz.");
